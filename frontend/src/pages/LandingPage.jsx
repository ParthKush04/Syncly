  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <div className="pointer-events-none fixed inset-0 -z-30 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.34),transparent_26%),radial-gradient(circle_at_top_right,rgba(251,146,60,0.3),transparent_24%),radial-gradient(circle_at_35%_80%,rgba(236,72,153,0.22),transparent_28%),radial-gradient(circle_at_80%_78%,rgba(168,85,247,0.24),transparent_30%),linear-gradient(135deg,#050816_0%,#09122f_26%,#2b1b5a_52%,#7c2d12_76%,#0f172a_100%)]" />
        <div className="pointer-events-none fixed inset-0 -z-30 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.34),transparent_26%),radial-gradient(circle_at_top_right,rgba(236,72,153,0.28),transparent_24%),radial-gradient(circle_at_35%_80%,rgba(236,72,153,0.22),transparent_28%),radial-gradient(circle_at_80%_78%,rgba(168,85,247,0.24),transparent_30%),linear-gradient(135deg,#050816_0%,#09122f_26%,#2b1b5a_52%,#1d2b5c_76%,#0f172a_100%)]" />
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center overflow-hidden text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.34),transparent_24%),radial-gradient(circle_at_top_right,rgba(251,146,60,0.28),transparent_22%),radial-gradient(circle_at_32%_78%,rgba(236,72,153,0.2),transparent_26%),radial-gradient(circle_at_78%_70%,rgba(168,85,247,0.25),transparent_28%),linear-gradient(135deg,#050816_0%,#0b1636_24%,#312e81_52%,#b45309_78%,#020617_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.34),transparent_24%),radial-gradient(circle_at_top_right,rgba(236,72,153,0.26),transparent_22%),radial-gradient(circle_at_32%_78%,rgba(236,72,153,0.2),transparent_26%),radial-gradient(circle_at_78%_70%,rgba(168,85,247,0.25),transparent_28%),linear-gradient(135deg,#050816_0%,#0b1636_24%,#312e81_52%,#1d2b5c_78%,#020617_100%)]" />
      ...
      <div className="absolute right-[-5rem] top-28 h-72 w-72 rounded-full bg-fuchsia-400/20 blur-3xl animate-drift-slow" />
        <div className="absolute right-[-5rem] top-28 h-72 w-72 rounded-full bg-fuchsia-400/20 blur-3xl animate-drift-slow" />
