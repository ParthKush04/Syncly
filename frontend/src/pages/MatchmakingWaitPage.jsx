    ...
    <main className="min-h-screen px-4 py-8 text-white sm:px-6 lg:px-10 lg:py-10">
      <div className="mx-auto w-full">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch min-h-[65vh]">
          {/* Left camera panel (when no match, span both columns and show large searching orb) */}
          <section className={`rounded-[2rem] card-dark-strong p-6 shadow-2xl shadow-black/30 sm:p-8 w-full flex flex-col h-full ${!matchPartner ? 'lg:col-span-2' : ''}`}>
